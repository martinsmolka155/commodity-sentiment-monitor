...
from app.config import CHUNK_DURATION_SECONDS, CHUNKS_DIR, INPUT_FILE, MAX_RETRIES, SAMPLE_RATE
...
async def produce_chunks(chunk_queue: asyncio.Queue, input_file: str | None = None) -> None:
    """Split audio and feed WAV chunk paths into the queue, simulating live stream timing."""
